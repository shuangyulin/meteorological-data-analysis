<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"140px 0 0 220px","margin":"0","position":"relative","background":"#E7E7E7","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0 ","alignItems":"center","color":"#333","display":"flex","justifyContent":"space-between","top":"0","left":"0","background":"linear-gradient( 127deg, #0E789C 0%, #41C7FF 100%)","width":"100%","fontSize":"16px","position":"fixed","zIndex":"1001","height":"90px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0 20px","margin":"0px auto 0 0px","borderColor":"#3b6885","alignItems":"center","top":"90px","borderWidth":"0 0 0px 0","background":"#fff","width":"100%","fontSize":"16px","lineHeight":"50px","position":"fixed","borderStyle":"solid","height":"50px","zIndex":"2"}' class="bread-crumbs"></bread-crumbs>
